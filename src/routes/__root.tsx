...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Copa Épica — Palpites e Ranking" },
      { name: "twitter:description", content: "App brutalista de palpites esportivos. Marque presença no ranking da Copa Épica." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/cdf1761a-6488-4c88-a8c1-6dae2dc9787e/id-preview-172b41c2--30fe4bfb-1c1c-4517-b45c-eb3890fd1a0f.lovable.app-1781213842463.png" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Inter:wght@400;500;600;700;800;900&family=Roboto:wght@400;500;700;900&display=swap",
      },
    ],
  }),
